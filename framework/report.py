...
def set_env_to_report():
    ...
    allure_env_file = os.path.join(workdir, "allure", 'environment.properties')
...
def set_executor_to_report():
    ...
    allure_env_file = os.path.join(workdir, "allure", 'executor.json')
    with open(allure_env_file, 'w', encoding='utf-8') as f:
...
def set_categories_to_report():
    ...
    allure_env_file = os.path.join(workdir, "allure", 'categories.json')
    with open(allure_env_file, 'w', encoding='utf-8') as f:
